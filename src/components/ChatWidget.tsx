...
//   onClose: () => void;
//   client?: Client | null;
//   address?: string | null; // ⭐ receive address from App
//   adminAddress: string;
// }
...
//   // Compare connected wallet address vs ADMIN_ADDRESS
//   const isAdmin =
...
//       className="fixed bottom-20 right-4 w-96 h-[600px] bg-white rounded-xl shadow-xl overflow-hidden flex flex-col z-50"
//     >
//       {/* Header */}
