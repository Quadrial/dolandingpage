...
const allFeaturedDomains = [
  {
    ...
    status: "Premium",
    statusColor: "bg-green-100 text-green-800",
    description: "Perfect for Web3 startups.",
    price: "5.2 ETH",
  },
  {
    name: "nft.art",
  ...
  },
  {
    ...
    status: "Trending",
    statusColor: "bg-purple-100 text-purple-800",
    description: "Excellent for DAOs.",
    price: "7.5 ETH",
  },
  {
    name: "metaverse.io",
    status: "Hot",
    statusColor: "bg-red-100 text-red-800",
    description: "For metaverse projects.",
    price: "6.1 ETH",
  },
  {
    name: "token.xyz",
    status: "New",
    statusColor: "bg-blue-100 text-blue-800",
    description: "Memorable token domain.",
    price: "2.5 ETH",
  },
  {
    name: "defi.org",
    status: "Premium",
    statusColor: "bg-green-100 text-green-800",
    description: "Top-tier domain for DeFi.",
    price: "9.0 ETH",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <motion.p
            ...
            className="text-gray-600 max-w-2xl mx-auto"
          >
            Discover premium domains available for immediate purchase.
          </motion.p>
        </div>
            ...
            >
              ...
              <div className="flex justify-between items-center">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 transition"
                  onClick={() => onNegotiate(domain.name, domain.price)}
                >
                  Negotiate
                </motion.button>
              </div>
